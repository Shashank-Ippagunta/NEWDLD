...
Ion.defaultAccessToken =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiJmYTk3MGNmYy0xOTM3LTQ3NDctYjNmOS1jNTRmMmNiMTMyNWEiLCJpZCI6MTg1MzUyLCJpYXQiOjE3MDI5OTc5OTh9.ugcyQ7GxmVYUf1r9tYRs9oQH2-_WluiNUCyCX43agHo";
...
const dataSource = Cesium.GeoJsonDataSource.load(
  "../public/Hudayriyat Central_25Dec2023.json");
...
const minWGS84 =[54.380177, 24.401152];
const maxWGS84 =[54.380485, 24.401625];
...
const file = await fetch("rac.ifc");
const data = await file.arrayBuffer();
const buffer = new Uint8Array(data);
const model = await ifcLoader.load(buffer, "rac");
